...
for idx in range(ortholog_df.shape[0]):
    ...
    # Else there are sites to do computations on.
        ...
        # Else-if there are only synonmous coding mutations.
            ...
            int_mask = ~syn_mask
            # Compute fst.
            syn_san_mel = calc_fst(
                gt=allel.GenotypeArray(callset[gene_loc]),
                pop_a=idx_dicc['san'], pop_b=idx_dicc['mel'],
            )
            syn_san_tei = calc_fst(
                gt=allel.GenotypeArray(callset[gene_loc]),
                pop_a=idx_dicc['san'], pop_b=idx_dicc['tei'],
            )
            syn_san_yak = calc_fst(
                gt=allel.GenotypeArray(callset[gene_loc]),
                pop_a=idx_dicc['san'], pop_b=idx_dicc['yak'],
            )
            syn_san_symp = calc_fst(
                gt=allel.GenotypeArray(callset[gene_loc]),
                pop_a=idx_dicc['san'], pop_b=idx_dicc['yak_symp'],
            )
            syn_san_allo = calc_fst(
                gt=allel.GenotypeArray(callset[gene_loc]),
                pop_a=idx_dicc['san'], pop_b=idx_dicc['yak_allo'],
            )
            syn_tei_mel = calc_fst(
                gt=allel.GenotypeArray(callset[gene_loc]),
                pop_a=idx_dicc['tei'], pop_b=idx_dicc['mel'],
            )
            syn_tei_yak = calc_fst(
                gt=allel.GenotypeArray(callset[gene_loc]),
                pop_a=idx_dicc['tei'], pop_b=idx_dicc['yak'],
            )
            syn_tei_symp = calc_fst(
                gt=allel.GenotypeArray(callset[gene_loc]),
                pop_a=idx_dicc['tei'], pop_b=idx_dicc['yak_symp'],
            )
            syn_tei_allo = calc_fst(
                gt=allel.GenotypeArray(callset[gene_loc]),
                pop_a=idx_dicc['tei'], pop_b=idx_dicc['yak_allo'],
            )
            syn_yak_mel = calc_fst(
                gt=allel.GenotypeArray(callset[gene_loc]),
                pop_a=idx_dicc['yak'], pop_b=idx_dicc['mel'],
            )
            syn_symp_allo = calc_fst(
                gt=allel.GenotypeArray(callset[gene_loc]),
                pop_a=idx_dicc['yak_symp'], pop_b=idx_dicc['yak_allo'],
            )
            # Append the results.
            ...
            # Else there are intronic mutations.
                ...
                # Compute fst.
                int_san_mel = calc_fst(
                    gt=allel.GenotypeArray(callset[gene_loc]),
                    pop_a=idx_dicc['san'], pop_b=idx_dicc['mel'],
                )
                int_san_tei = calc_fst(
                    gt=allel.GenotypeArray(callset[gene_loc]),
                    pop_a=idx_dicc['san'], pop_b=idx_dicc['tei'],
                )
                int_san_yak = calc_fst(
                    gt=allel.GenotypeArray(callset[gene_loc]),
                    pop_a=idx_dicc['san'], pop_b=idx_dicc['yak'],
                )
                int_san_symp = calc_fst(
                    gt=allel.GenotypeArray(callset[gene_loc]),
                    pop_a=idx_dicc['san'], pop_b=idx_dicc['yak_symp'],
                )
                int_san_allo = calc_fst(
                    gt=allel.GenotypeArray(callset[gene_loc]),
                    pop_a=idx_dicc['san'], pop_b=idx_dicc['yak_allo'],
                )
                int_tei_mel = calc_fst(
                    gt=allel.GenotypeArray(callset[gene_loc]),
                    pop_a=idx_dicc['tei'], pop_b=idx_dicc['mel'],
                )
                int_tei_yak = calc_fst(
                    gt=allel.GenotypeArray(callset[gene_loc]),
                    pop_a=idx_dicc['tei'], pop_b=idx_dicc['yak'],
                )
                int_tei_symp = calc_fst(
                    gt=allel.GenotypeArray(callset[gene_loc]),
                    pop_a=idx_dicc['tei'], pop_b=idx_dicc['yak_symp'],
                )
                int_tei_allo = calc_fst(
                    gt=allel.GenotypeArray(callset[gene_loc]),
                    pop_a=idx_dicc['tei'], pop_b=idx_dicc['yak_allo'],
                )
                int_yak_mel = calc_fst(
                    gt=allel.GenotypeArray(callset[gene_loc]),
                    pop_a=idx_dicc['yak'], pop_b=idx_dicc['mel'],
                )
                int_symp_allo = calc_fst(
                    gt=allel.GenotypeArray(callset[gene_loc]),
                    pop_a=idx_dicc['yak_symp'], pop_b=idx_dicc['yak_allo'],
                )
                # Append the results.
        ...
        # Else-if there are only missense coding mutations.
            ...
            int_mask = ~mis_mask
            # Compute fst.
            mis_san_mel = calc_fst(
                gt=allel.GenotypeArray(callset[gene_loc]),
                pop_a=idx_dicc['san'], pop_b=idx_dicc['mel'],
            )
            mis_san_tei = calc_fst(
                gt=allel.GenotypeArray(callset[gene_loc]),
                pop_a=idx_dicc['san'], pop_b=idx_dicc['tei'],
            )
            mis_san_yak = calc_fst(
                gt=allel.GenotypeArray(callset[gene_loc]),
                pop_a=idx_dicc['san'], pop_b=idx_dicc['yak'],
            )
            mis_san_symp = calc_fst(
                gt=allel.GenotypeArray(callset[gene_loc]),
                pop_a=idx_dicc['san'], pop_b=idx_dicc['yak_symp'],
            )
            mis_san_allo = calc_fst(
                gt=allel.GenotypeArray(callset[gene_loc]),
                pop_a=idx_dicc['san'], pop_b=idx_dicc['yak_allo'],
            )
            mis_tei_mel = calc_fst(
                gt=allel.GenotypeArray(callset[gene_loc]),
                pop_a=idx_dicc['tei'], pop_b=idx_dicc['mel'],
            )
            mis_tei_yak = calc_fst(
                gt=allel.GenotypeArray(callset[gene_loc]),
                pop_a=idx_dicc['tei'], pop_b=idx_dicc['yak'],
            )
            mis_tei_symp = calc_fst(
                gt=allel.GenotypeArray(callset[gene_loc]),
                pop_a=idx_dicc['tei'], pop_b=idx_dicc['yak_symp'],
            )
            mis_tei_allo = calc_fst(
                gt=allel.GenotypeArray(callset[gene_loc]),
                pop_a=idx_dicc['tei'], pop_b=idx_dicc['yak_allo'],
            )
            mis_yak_mel = calc_fst(
                gt=allel.GenotypeArray(callset[gene_loc]),
                pop_a=idx_dicc['yak'], pop_b=idx_dicc['mel'],
            )
            mis_symp_allo = calc_fst(
                gt=allel.GenotypeArray(callset[gene_loc]),
                pop_a=idx_dicc['yak_symp'], pop_b=idx_dicc['yak_allo'],
            )
            # Append the results.
...
np.savetxt(
    f'./results/{ref}/{miss}/fst_int_orthologs.txt.gz',
    int_mat, fmt='%1.15f', delimiter='\t', newline='\n',
)
np.savetxt(
    f'./results/{ref}/{miss}/fst_syn_orthologs.txt.gz',
    syn_mat, fmt='%1.15f', delimiter='\t', newline='\n',
)
np.savetxt(
    f'./results/{ref}/{miss}/fst_mis_orthologs.txt.gz',
